      ...
      <div className="sm:flex block">
        {isMediumScreen ? (
          <motion.div
            ...
            className="flex-1 sm:mb-0 mb-14 flex flex-col justify-center items-start"
          >
          ...
          <div className="flex-1 sm:mb-0 mb-14 flex flex-col justify-center items-start">
            <p className={styles.sectionSubText}>My Works</p>
            <h2 className={styles.sectionHeadText}>Projects.</h2>
        ...
        {isMediumScreen ? (
          <motion.div
            ...
            className="flex-1 flex sm:flex-col flex-row justify-center items-center"
          >
            <h2 className="text-white font-black md:text-[40px] sm:text-[30px] xs:text-[20px] text-[10px] text-center sm:block hidden">
              Socials
            </h2>
            <div
          ...
          <div className="flex-1 flex sm:flex-col flex-row justify-center items-center">
            <h2 className="text-white font-black md:text-[40px] sm:text-[30px] xs:text-[20px] text-[10px] text-center sm:block hidden">
              Socials
            </h2>
            <div
